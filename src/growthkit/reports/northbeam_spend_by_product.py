#!/usr/bin/env python3
"""Northbeam spend by product/category report.

Refactored from scripts/northbeam_spend_by_product.py into a library module.
"""
...
DEFAULT_INPUT_DIR = Path(__file__).resolve().parents[3] / "data" / "ads"
DEFAULT_OUTPUT_DIR = (
    Path(__file__).resolve().parents[3] / "data" / "ads" / "q4-planning-2025" / "ads"
)
