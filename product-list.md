...
summaries_dict = {
    ...
    "DailyDOSE Time‑Marked Glass Water Bottle": "Heat‑safe glass bottle with hourly markers to encourage chemical‑free hydration before and after sweat sessions.",
    ...
    "eGift Card": "Digital gift card in multiple denominations allowing recipients to choose their preferred HigherDOSE wellness products."
}
...
categories = {
    ...
    "Bundle & Save": [
        ...
        "Summer Body Recover & Sculpt",
        "Summer Travel Glow Kit",
        "Best Seller Bundle",
        "Turn Me On Kit",
        "PEMF Go Mat Starter Kit",
        "Endorphin Kit",
        "Oxytocin Kit",
        "The Supermom Bundle",
        "The Sweat it Out Bundle",
        "After Bedtime Bundle"
    ],
    "Accessories": [
        "Supercharge Copper Body Brush",
        "SweatBand",
        "EMF Blocking Fanny Pack",
        "Infrared Sauna Blanket Insert",
        "High Maintenance Cleaner",
        "DailyDOSE Time‑Marked Glass Water Bottle",
        "Sauna Blanket Bag",
        "PEMF Mat Cover",
        "100% Organic Cotton Bath Robe"
    ],
    "Supplements": [
        "Detox Drops",
        "High‑Dration Powder",
    ...
    "Body Care": [
        ...
        "Endorphin Oil",
        "Serotonin Soak Salt",
        "Light‑Activated Glow Serum",
        "Oxytocin Oil",
        "Daily Dose Ritual",
        "Sculpting Activator Gel"
    ],
    "Gifting": [
        "eGift Card"
    ]
...
md_lines = [
    "# HigherDOSE Products – Descriptions\n",
...
for cat, products in categories.items():
    ...
    for name in products:
        summary = summaries_dict.get(name, "")
        md_lines.append(f"- **{name}**: {summary}\n")
    md_lines.append("")  # add blank line between categories

combined_file = "/mnt/data/higherdose_products_with_summaries.md"
